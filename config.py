...
class Config(object):
    ...
    params = urllib.parse.quote_plus("DRIVER={/opt/microsoft/msodbcsql17/lib64/libmsodbcsql-17.0.so.1.1};SERVER=cms-udacity.database.windows.net;DATABASE=cms-db;UID=cmsadmin;PWD=Password@123")
